...
def test_position_decision_construction_normalizes_basic_invariants() -> None:
    ...
    decision = PositionDecision(
        ...
        yoyo_opinion="Sizing risk requires review.",
...
def test_position_decision_requires_real_bool_values() -> None:
    ...
    with pytest.raises(ValueError, match="action_required must be bool"):
        PositionDecision(
            ...
            yoyo_opinion="Risk is manageable.",
...
def test_no_action_position_decision_requires_no_action_and_no_urgency() -> None:
    ...
    decision = PositionDecision(
        ...
        yoyo_opinion="Risk level does not require intervention.",
...
def test_action_recommendations_require_human_review(
    ...
    with pytest.raises(
        ...
        PositionDecision(
            ...
            yoyo_opinion="Risk requires explicit human review.",
